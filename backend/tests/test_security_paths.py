"""Security tests — path safety, archive extraction, and subtitle sanitization.
...
- TestIsSafePath: is_safe_path() and path traversal tests
"""
...
class TestSubtitleSanitizer:
    ...
    def test_ass_unclosed_drawing_openers_do_not_stall(self):
        ...
        # No closer anywhere, so nothing is a complete drawing block and the
        # openers stay. Briefly removed on 2026-09-18 and put back after
        # measuring the library: unclosed is how a drawing is normally
        # written, 23 % of files and 2.7 million events carry one, and
        # stripping them would delete that typesetting from everything
        # Sublarr writes. This test is about the cost, which is unchanged.
