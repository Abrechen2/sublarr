...
NOTE: This file is intentionally ~1085 LOC. WantedScanner is a stateful
coordinator (scanning + searching + scheduling) that cannot be cleanly split
without complex mixin inheritance. Documented as accepted exception.
"""
