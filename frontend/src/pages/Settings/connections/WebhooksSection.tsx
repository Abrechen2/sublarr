/**
 * WebhooksSection — Read-only display of incoming webhook URLs.
 *
 * Lists Sonarr / Radarr / Jellyfin webhook endpoints with copy-to-clipboard.
 * Used by SystemHooksPage. Extracted from SystemHooksPage.tsx so the same
 * markup is no longer duplicated in an orphan WebhooksPage.tsx and the
 * test for this surface targets one canonical component.
 */
