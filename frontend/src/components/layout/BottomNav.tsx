              ...
              <div className="relative">
                ...
                {showBadge && wantedCount > 0 && (
                  <span
                    ...
                    className="absolute -top-1.5 left-full text-[9px] font-semibold leading-tight px-1 min-w-[14px] max-w-[28px] text-center rounded-full -translate-x-2/3 pointer-events-none"
                    style={{
