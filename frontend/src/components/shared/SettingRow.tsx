...
export function SettingRow({
  ...
  return (
    <div
      className={`grid grid-cols-1 md:grid-cols-[200px_1fr] gap-2 md:gap-6 items-start py-3 ${className}`}
      style={advanced ? { borderLeft: '2px solid var(--warning)', paddingLeft: '10px' } : undefined}
    >
